...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ProUpdates")
                await self.one.join_chat("ProSupport")
                await self.one.join_chat("TeamPro")
                await self.one.join_chat("ProStatus")
                await self.one.join_chat("ProBots")
            except:
                pass
            assistants.append(1)
            try:
